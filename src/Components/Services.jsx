...
// const Services = () => {
//   return (
//     <section className="max-container flex flex-col items-center gap-12 md:flex-row md:justify-center md:gap-9">

//       <div className="text-center md:text-left">
//         <hr className="mb-9 w-20 border-[1px]" />
//         <p className="font-DM font- text-4xl text-Dark-Violet">We're different</p>

//         <div className="flex flex-col md:flex-row md:gap-10 mt-16">
//           <div className="flex-1 md:w-[350px] w-full rounded-[20px] mb-10 md:mb-0 flex flex-col items-center">
//             <div className="w-11 h-11 flex justify-center items-center rounded-full bg-Grayish-Blue">
//               <img src={snappy} alt="icon" width={50} height={30} />
//             </div>
//             <h3 className="font-semibold font-DM text-Dark-Violet text-2xl mt-3">Snappy Process</h3>
//             <p className="font-karla font-[16px] text-dark-grayish-violet leading-normal mt-3">Our application process can be completed in minutes, not hours. Don't get stuck filling in tedious forms</p>
//           </div>

//           <div className="flex-1 md:w-[350px] w-full rounded-[20px] mb-10 md:mb-0 flex flex-col items-center">
//             <div className="w-11 h-11 flex justify-center items-center rounded-full bg-Grayish-Blue">
//               <img src={affordable} alt="icon" width={50} height={30} />
//             </div>
//             <h3 className="font-semibold font-DM text-Dark-Violet text-2xl mt-3">Affordable Prices</h3>
//             <p className="font-karla font-[16px] text-dark-grayish-violet leading-normal mt-3">We won't want you worrying about high monthly costs. Our prices may be low, but we still offer the best coverage possible.</p>
//           </div>

//           <div className="flex-1 md:w-[350px] w-full rounded-[20px] flex flex-col items-center">
//             <div className="w-11 h-11 flex justify-center items-center rounded-full bg-Grayish-Blue">
//               <img src={people} alt="icon" width={50} height={30} />
//             </div>
//             <h3 className="font-semibold font-DM text-Dark-Violet text-2xl mt-3">People First</h3>
//             <p className="font-karla font-[16px] text-dark-grayish-violet leading-normal mt-3">Our plans aren't full of conditions and clauses to prevent payouts. We make sure you're covered when you need it.</p>
//           </div>
//         </div>
//       </div>
//     </section>
