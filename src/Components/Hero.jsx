...
const Hero = () => {
  return (
    <section className='w-full flex flex-col min-h-[72vh] gap-10 max-container bg-Dark-Violet relative '>


      <div className='relative justify-center flex-col items-center ml-10   xl:w-2/5 max-xl:padding-x '>
